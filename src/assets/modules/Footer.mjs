  ...
  footer({ id: 'contact', class: 'Footer' }, [
    div({ class: 'Container' }, [
      div({ class: 'Social' }, [
        Link(
          {
            to: 'https://www.instagram.com/nadezhda_miru/',
          },
          [
            svg({ viewBox: '0 0 512 512', height: '45' }, [
              ...
              circle({ fill: '#0c0c0c', cx: '391', cy: '122', r: '30' }),
            ]),
          ],
        ),
        // Link(
